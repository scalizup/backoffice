<script lang="ts">
	...
	import type { CreateSchemaStep2 } from '../schemas';
	import type { TagGroup } from '$lib/api/contracts/tag_groups/api';
	import type { PaginatedData } from '$lib/api/contracts/common';
	...
	export let form: SuperForm<Infer<CreateSchemaStep2>>;
